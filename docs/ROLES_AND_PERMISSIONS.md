...
| Catalogs | Maintain expected-component definitions for assembly categories | ALLOW | DENY | DENY | CAT-001, HIER-006, HIER-011, ADMIN-001. The list is general per assembly category; applicability is reviewed per received unit. |
