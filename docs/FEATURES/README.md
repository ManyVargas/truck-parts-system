...
| `11_COST_AND_PROFITABILITY.md` | DOP cost, profit, USD FX enrichment | Release 2/4/5 | **API done** for invoice-line cost/FX/profit. **HTTP UI pending (R2 M24)**. Inventory cost correction **not** in API |
